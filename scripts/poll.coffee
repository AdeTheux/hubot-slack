...
#
# Commands:
#   nestor poll <question> -a <answers> - Create a poll with comma separated answers
#   nestor (end|stop|close) poll - End current poll and show results
#   nestor vote <number> - Cast your vote
#   nestor previous poll - Previous poll results
#
# Notes:
...
class Poll
  ...
  createPoll: (msg) =>
    ...
    Type the following: "alfred #", where # is the number of your answer. "alfred 0" to cancel your vote.
    #{this.printAnswers()}
    """
